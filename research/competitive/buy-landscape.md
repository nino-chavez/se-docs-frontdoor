...
> **Two candidates this scan never covered, noted 2026-07-31.** **Unblocked** and **Sourcegraph** were named in an unrelated analysis as entries in the ramping-onto-unfamiliar-systems category. Neither appears anywhere in this document. That analysis graded its own market claims as recollection rather than verified capability, so they enter at the same grade — **`Reported`, unverified.** Check before repeating. Its headline conclusion, reached independently and against a different vendor set, matched this document's: retrieval is commodity, reconciliation is not. Independent convergence is worth more than either read alone.
